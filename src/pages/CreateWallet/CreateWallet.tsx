...
export const CreateWallet: React.FC = () => {
    ...
    const [isVerificationPhase, setIsVerificationPhase] = useState<boolean>(false);
    ...
    const handleCreateWallet = async () => {
        try {
            ...
            setVerificationWords(randomIndices.map(index => ({index, word: words[index]})));
        } catch (error) {
    ...
    const handleVerify = () => {
        let isValid = true;
        for (let {index, word} of verificationWords) {
    ...
    return (
        <div className='flex flex-col p-6 max-w-2xl w-full bg-white shadow-md rounded h-full'>
            <div className='flex flex-col gap-6'>
                <h2 className='text-2xl font-bold p-2 mb-2 text-center'>Create Wallet</h2>
                <div className='text-sm border border-gray-200 rounded-xl p-6'>
                    {!isVerificationPhase ? (
                        <>
                            ...
                            <button onClick={handleCreateWallet} className='w-full bg-blue-500 text-white py-3 rounded-md text-base'>
                                Create Wallet
                            </button>
                            {mnemonic && (
                                <div className='mt-4'>
                                    ...
                                    <p>{mnemonic}</p>
                                    <button onClick={() => copyToClipboard(mnemonic)} className='w-full bg-yellow-500 text-white py-3 rounded-md text-base mt-2'>
                                        Copy Mnemonic
                                    </button>
                                </div>
                            )}
                                ...
                                <div className='mt-4'>
                                    <label className='flex items-center'>
                                        <input
                                            ...
                                            className='mr-2'
                                        />
                                        <span>I acknowledge that if I lose my mnemonic, my wallet cannot be recovered.</span>
                                    </label>
                                    <button
                        ...
                        <>
                            {!isVerified ? (
                                <>
                                    ...
                                    <button onClick={handleVerify} className='w-full bg-green-500 text-white py-3 rounded-md text-base mt-2'>
                                ...
                                <div className='text-center'>
                                    ...
                                    <h3 className='text-lg font-bold mt-4'>Wallet Created Successfully!</h3>
                                    <p className='mt-2'>Your wallet is ready. Enjoy the world of blockchain!</p>
                                    <button
